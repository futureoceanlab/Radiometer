...
entity CLK_250_450_CLK_250_450_clk_wiz is
  port (
...
architecture STRUCTURE of CLK_250_450_CLK_250_450_clk_wiz is
  signal clk_250_CLK_250_450 : STD_LOGIC;
  signal clk_450_CLK_250_450 : STD_LOGIC;
  signal clkfbout_CLK_250_450 : STD_LOGIC;
  signal clkfbout_buf_CLK_250_450 : STD_LOGIC;
...
entity CLK_250_450 is
  ...
  attribute NotValidForBitStream of CLK_250_450 : entity is true;
end CLK_250_450;

architecture STRUCTURE of CLK_250_450 is
begin
inst: entity work.CLK_250_450_CLK_250_450_clk_wiz
     port map (
      clk_250 => clk_250,
      clk_450 => clk_450
    );
