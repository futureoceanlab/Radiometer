...
#define EMULATOR_ENABLE 0 // Set to 1 line to have teensy run as emulator, generating synthetic data
...
static const byte pin_DataLow[] =  {14, 21, 22, 10, 11, 41, 12, 28};
static const byte pin_DataHigh[]  = { 3, 13,  6,  7,  5,  8, 20,  4};  // D(00:07) Byte 2
#define DATA00 14
#define DATA01 21
#define DATA02 22
#define DATA03 10
...
// INPUT PINS: OTHER
static const byte pin_HamRdy    =  25; //  A12  HIGH: Hamamatsu Ready    LOW: Hamamatsu offline
static const byte pin_PwrDwn    =  23; //  C11  HIGH: Power is going down in 10s, burn the files, save Cannoli
static const byte pin_CMODRdy   =  30;

// Output Pins
static const byte pin_NsSel[]   = {40, 37, 29}; // E26 A05 A16   Binary NS select lines 

//static const byte pin_Dtog      = 33;  //   HIGH: request Pulse count        LOW: request Cycle count
#define pin_Dtog 33  //   HIGH: request Pulse count        LOW: request Cycle count
static const byte pin_Reset     =  9;  //   HIGH: reset FPGA counters        LOW: enable counters
static const byte pin_HamPwr    = 24;  //   HIGH: Enable Ham Load Switch     LOW: Disable 
static const byte pin_KillMePls = 15;  //   HIGH: Cmod, T36 load switch off  LOW: DEFAULT 
static const byte pin_EN_CMOD   =  2;

// COMMS PINS
static const byte pin_I2C0_SDA  = 19;  // 
static const byte pin_I2C0_SCL  = 18;  // 

static const byte pin_Ser1_TX   = 01;  //  TX
static const byte pin_Ser1_RX   = 00;  //  RX 

static const byte pin_SPI1_MOSI = 26;  // B16 MOSI 
static const byte pin_SPI1_MISO = 39;  // B17 MISO
static const byte pin_SPI1_CS   = 38;  // B10 CS
static const byte pin_SPI1_SCK  = 27;  // B11 SCK
